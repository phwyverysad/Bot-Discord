...
Const BOT_NAME = "Discord Server Cloner & Backup"
Const HIDDEN_MODE = 0
...
Function FindBotProcesses()
    ...
    For Each process In colProcesses
        ...
        If InStr(1, cmdLine, BotScript, vbTextCompare) > 0 Or (InStr(1, cmdLine, BOT_SCRIPT_NAME, vbTextCompare) > 0 And InStr(1, cmdLine, "copy discord", vbTextCompare) > 0) Then
            If botPIDs = "" Then
